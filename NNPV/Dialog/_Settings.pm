...
# begin wxGlade: NNPV::Dialog::_Settings::__do_layout
	...
	$self->{sizer_default_image_line1} = Wx::BoxSizer->new(wxHORIZONTAL);
	...
	$self->{sizer_default_image_line1}->Add($self->{radio_btn_default_image_default}, 0, wxALL|wxALIGN_CENTER_VERTICAL, 4);
	$self->{sizer_default_image}->Add($self->{sizer_default_image_line1}, 1, wxEXPAND, 0);
